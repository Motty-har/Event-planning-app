...
Revision ID: 6c2ee67d9da2
Revises: 
Create Date: 2024-03-26 11:35:33.722139
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['invited_user_id'], ['users.id'], name=op.f('fk_notifications_invited_user_id_users')),
    sa.PrimaryKeyConstraint('id')
    )
